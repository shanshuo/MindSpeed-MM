...
class ModelInputForNPU(ModelRunnerInputBase):
    ...
    # NEXT PLAN: What happens when we depickle this object?
...
class ModelInputForNPUBuilder(ModelRunnerInputBuilderBase[ModelInputForNPU]):
    ...
    def _compute_lens(self, inter_data: InterDataForSeqGroup, seq_idx: int,
        ...
        # Compute tokens.
        # NEXT PLAN: this is for the version compatibility, remove this once vllm v0.8.5 does not be supported.
    ...
    def _compute_for_sliding_window(self, inter_data: InterDataForSeqGroup,
        ...
        if not inter_data.is_prompt and self.sliding_window is not None:
            # NEXT PLAN(sang): This is a hack to make sliding window work with
...
class NPUModelRunner(NPUModelRunnerBase[ModelInputForNPUWithSamplingMetadata]):
    ...
    def prepare_model_input(
        ...
        if get_pp_group().is_last_rank:
            ...
            sampling_metadata = SamplingMetadata.prepare(
                ...
                # NEXT PLAN (cmq): enable this after supported in vllm
    ...
    def execute_model(
        ...
        **kwargs,
        ...
        # NEXT PLAN(andoorve): We can remove this once all
