...
from checkpoint.vlm_model.utils import ConvertHFConfig, ConvertResplitConfig, ConvertMMConfig, ConvertVppMMConfig, ConvertVppHFConfig
...
class Qwen2VLConverter(Converter):
    ...
    def mm_to_hf(cfg: ConvertHFConfig):
        ...
        from checkpoint.vlm_model import qwen2vl_mm_to_hf
...
class Qwen2_5_VLConverter(Converter):
    ...
    def mm_to_hf(cfg: ConvertHFConfig):
        ...
        from checkpoint.vlm_model import qwen2_5_vl_mm_to_hf
